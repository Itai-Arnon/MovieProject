...
public class MoviesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ArrayList<MovieModel> movieList = loadMovies();

        rView =  findViewById(R.id.movies_ls);
        //rView.setHasFixedSize(true);

        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(this);
        rView.setLayoutManager(mLayoutManager);
        mAdapter = new MovieRecyclerAdapter(movieList, new PageList());
        ...
        class PageList implements MovieRecyclerAdapter.PagerListener {
            ...
            public void gotoFragmentListener(MovieModel movie) {
                Intent movieIntent = new Intent(MoviesActivity.this, DetailActivity.class);
                movieIntent.putExtra(MOVIE_DATA, movie);
